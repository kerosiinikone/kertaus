  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center bg-gradient-to-l from-neutral-100 to-neutral-150 min-w-content md:mx-10 mx-0 rounded-2xl shadow-lg md:p-2 p-0">
        <div className="flex flex-col bg-white min-w-content rounded-xl">
          <Link href={"/me"}>
            <IconContext.Provider
              value={{
                className: "fill-slate-500 hover:fill-slate-700 transition m-4",
              }}
            >
              <CiCircleRemove size="40px" />
            </IconContext.Provider>
          </Link>

          <div className="flex flex-col justify-center items-center space-y-5 bg-white min-w-content rounded-xl md:p-7 p-5">
            <div>
